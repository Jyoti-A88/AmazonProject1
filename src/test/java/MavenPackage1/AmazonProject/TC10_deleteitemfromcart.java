...
public class TC10_deleteitemfromcart extends Baseclass{
	
	@Test(retryAnalyzer = IRetryanalyserPage.class)
	public void deleteproductincart() throws InterruptedException, EncryptedDocumentException, IOException
	{
